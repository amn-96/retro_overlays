...
(Portrait) Overlay Y Offset 		0.065  		The top of the overlay will be off screen
...
## GBC 
Use with **non-integer scaling** and `GBC_top.cfg`
...
## PSX
Use with **non-integer scaling** and `PSX_top.cfg`
...
## SNES
This one is more involved. There are two options, both use `SNES_top.cfg`.
...
Custom Aspect Ratio (Height)		717 (3x)	Use the DPAD to select the mulitpliers
